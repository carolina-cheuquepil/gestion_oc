...
from .views import activos_fijos_list, activos_informatica_list, registrar_activos_fijos, traspasar_activo_fijo

urlpatterns = [
    path("activos/", activos_fijos_list, name="activos_list"),
    path("activos/informatica/", activos_informatica_list, name="activos_informatica_list"),
